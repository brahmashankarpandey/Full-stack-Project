...
function handleEdit() {
  ...
  if (postContent.contentEditable === "true" && post.title.startsWith("UPDATED:")) {
    postTitle.contentEditable = "false";
    postContent.contentEditable = "false";
    editButton.innerHTML = 'Edit <i class="fa fa-pen-to-square">';
    postTitle.style.border = "none";
    postContent.style.border = "none";
    displayPost();
  }
  else if (postContent.contentEditable === "true") {
    post.title = "UPDATED: " + postTitle.textContent;
    post.content = "<p class=" + "updated" + ">UPDATED:</p>" + postContent.textContent;
    postTitle.contentEditable = "false";
    postContent.contentEditable = "false";
    editButton.innerHTML = 'Edit <i class="fa fa-pen-to-square">';
    postTitle.style.border = "none";
